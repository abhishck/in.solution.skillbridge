...
const Services = () => {
  return (
    <>
      <Helmet>
        <title>IT Services | Skill Bridge Solutions</title>

        <meta
          name="description"
          content="Professional IT services including web development, AI solutions, UI/UX design, and software development."
        />
      </Helmet>
