...
export default function Internship() {
  ...
  return (
    <>
      <Helmet>
        <title>Internship Programs | Skill Bridge Solutions</title>

        <meta
          name="description"
          content="Explore practical internship programs in web development, AI, and software technologies with real-world projects."
        />
      </Helmet>
