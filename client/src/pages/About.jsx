        ...
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-400 mt-4 max-w-md sm:max-w-lg mx-auto md:mx-0 text-sm sm:text-base">
              Founded with a mission to close the gap between emerging tech
              talent and real-world industry demands, SkillBridge Technologies
              powers businesses with smart IT solutions while nurturing the next
